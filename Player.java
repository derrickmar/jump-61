...
abstract class Player {
    ...
    /** Returns the mutable board that the player is playing on. */
    final Board getMutableBoard() {
        return _game.getMutableBoard();
    }

    /** Ask my game to make my next move.  Assumes that I am of the
     *  proper color and that the game is not yet won. This is only
     *  used in AI*/
    abstract void makeMove();

    /** Ask my game to make my next move.  Assumes that I am of the
     *  proper color and that the game is not yet won. This is only
     *  used in HumanPlayer. We make move on ROW and COL. */
